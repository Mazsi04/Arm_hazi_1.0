...
{
    static const touchgfx::FontId DEFAULT = 0;       // javatext_13_4bpp
    static const touchgfx::FontId LARGE = 1;         // javatext_34_4bpp
    static const touchgfx::FontId SMALL = 2;         // javatext_17_4bpp
    static const touchgfx::FontId TYPOGRAPHY_00 = 3; // javatext_12_4bpp
    static const touchgfx::FontId TYPOGRAPHY_01 = 4; // arial_13_4bpp
    static const touchgfx::FontId TYPOGRAPHY_02 = 5; // javatext_11_4bpp
