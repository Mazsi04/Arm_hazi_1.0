...
extern touchgfx::GeneratedFont& getFont_LEELAWDB_TTF_13_4bpp();
extern touchgfx::GeneratedFont& getFont_LEELAWDB_TTF_35_4bpp();
extern touchgfx::GeneratedFont& getFont_LEELAWDB_TTF_20_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_LEELAWDB_TTF_13_4bpp()),
    &(getFont_LEELAWDB_TTF_35_4bpp()),
    &(getFont_LEELAWDB_TTF_20_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_LEELAWDB_TTF_13_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_LEELAWDB_TTF_35_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_LEELAWDB_TTF_20_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
